...
module.exports.create_Student = function(Student,callback) {
  ...
  var debugInfo = {
    enteringInto : "Student_Default_ActivityService",
    sendingRequestTo:"Student_Default_ActivityDao",
 ...
 dao.create_Student(Student,function (student){
  var responseDebugInfo = {
    enteringInto: "Student_Default_Activityservice",
    sendingResponseTo  : "Student_Default_ActivityController",
     ...
     if(student == '' || student == undefined || student == null )   
    {
      ...
      logger.info(" res : created Student is either empty or null in the service ",student);
       callback(student);
      ...
      responseDebugInfo.parameter = student;
      logger.debug(responseDebugInfo);
     logger.info("res : created Student in the service",student)
      var id = student._id;
      student.id = id;
      ...
      responseDebugInfo.parameter = student;
      logger.debug(responseDebugInfo);
      logger.error("cannot created Student in the service",student)
       callback(student);
